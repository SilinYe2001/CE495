...
# Global assignments 
set_global_assignment -name TOP_LEVEL_ENTITY "|udp_top"
...
set_global_assignment -section_id udp_top -name EDA_DESIGN_ENTRY_SYNTHESIS_TOOL "SYNPLIFY"
